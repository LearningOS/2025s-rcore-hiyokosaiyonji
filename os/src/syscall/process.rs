...
pub fn sys_mmap(start: usize, len: usize, port: usize) -> isize {
    ...
    inner
        .memory_set
        .insert_framed_area(start_va, VirtAddr::from(end), map_perm);
    0
}
